...
class TestSubstituteMutation:
    def test_equal_length_substitution(self):
        ...
        result = substitute_mutation(BASE_SEQ, pos=2, ref="TC", alt="AG", in_symbol=">", del_symbol="<")
    ...
    def test_substitution_with_insertion_padding(self):
        ...
        result = substitute_mutation(BASE_SEQ, pos=2, ref="TC", alt="AGGG", in_symbol=">", del_symbol="<")
    ...
    def test_substitution_with_deletion_padding(self):
        ...
        result = substitute_mutation(BASE_SEQ, pos=2, ref="TCG", alt="AG", in_symbol=">", del_symbol="<")
        assert result == "AAG<ATCG"

    def test_invalid_lengths(self):
        # Test ref length <= 1
        with pytest.raises(AlleleLengthError):
            substitute_mutation(BASE_SEQ, pos=2, ref="T", alt="AG", in_symbol=">", del_symbol="<")
        # Test alt length <= 1
        with pytest.raises(AlleleLengthError):
            substitute_mutation(BASE_SEQ, pos=2, ref="TC", alt="A", in_symbol=">", del_symbol="<")
...
class TestDeletion:
    ...
    def test_deletion_zero_index_error(self):
        """Test if zero-index error is detected."""
        with pytest.raises(ZeroIndexError):
            deletion_mutation("ATCGATCGATTGAC", 0, "ATCGATCGATTGAC", "A", del_symbol="<")
...
class TestLowercaseSequenceInput:
    ...
    def test_substitute_fails_on_lowercase_seq(self):
        ...
        with pytest.raises(UnexpectedRefError):
            substitute_mutation(seq="atcgatcg", pos=2, ref="TC", alt="AG", in_symbol=">", del_symbol="<")
...
class TestBoundaryPositions:
    ...
    def test_insertion_at_last_position(self):
        result = insertion_mutation(seq="ATCG", pos=4, ref="G", alt="GCC", in_symbol=">")
