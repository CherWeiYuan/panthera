...
def test_align_prob_wildtype(base_wt_acc, base_wt_dnr):
    ...
    scorer.align_prob()
    assert scorer.aligned_prob is not None
    assert scorer.reference_pos is not None
...
def test_align_prob_insertion(base_wt_acc, base_wt_dnr):
    ...
    # Expected Reference Positions: 100, 101, 101p1 (for >), 102, 103
    assert scorer.reference_pos == ["100", "101", "101p1", "102", "103"]
